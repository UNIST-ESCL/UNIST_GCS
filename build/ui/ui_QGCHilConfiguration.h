...
public:
    ...
    {
        QGCHilConfiguration->setWindowTitle(QApplication::translate("QGCHilConfiguration", "HIL Config", Q_NULLPTR));
        simLabel->setText(QApplication::translate("QGCHilConfiguration", "Simulator", Q_NULLPTR));
        simComboBox->clear();
        simComboBox->insertItems(0, QStringList()
         << QString()
         << QApplication::translate("QGCHilConfiguration", "FlightGear 3.0+", Q_NULLPTR)
