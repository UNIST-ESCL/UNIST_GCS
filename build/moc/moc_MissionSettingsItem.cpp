...
void MissionSettingsItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MissionSettingsItem *_t = static_cast<MissionSettingsItem *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (MissionSettingsItem::*_t)(bool );
...
const QMetaObject MissionSettingsItem::staticMetaObject = {
    { &ComplexMissionItem::staticMetaObject, qt_meta_stringdata_MissionSettingsItem.data,
      qt_meta_data_MissionSettingsItem,  qt_static_metacall, nullptr, nullptr}
};
