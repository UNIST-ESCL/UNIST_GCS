...
Item {
    ...
    property var _viewList: [ settingsViewLoader, setupViewLoader, planViewLoader, flightView, analyzeViewLoader, groupctrl ]
	...
	readonly property string _groupctrl:			"Group_Ctrl.qml"
    ...
    function showAnalyzeView() {
	 ...
	 function showGroupctrlView() {
        ...
        ScreenTools.availableHeight = 0
        if (groupctrl.source  != _groupctrl) {
            groupctrl.source  = _groupctrl
        }
        hideAllViews()
        groupctrl.visible = true
        toolBar.checkGroupctrlButton()
    }
    ...
    MainToolBar {
		...
		onShowGroupctrlView:    mainWindow.showGroupctrlView()
